  ...
  return (
    <Screen contentStyle={styles.content}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Sign in to monitor and control charging.</Text>
      ...
      <View style={styles.form}>
        ...
        <PrimaryButton title="Login" onPress={() => void vm.login(email, password)} loading={vm.loading} />
      </View>
